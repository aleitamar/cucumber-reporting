...
public class TagsHierarchyPage extends AbstractPage {
    ...
    public TagsHierarchyPage(ReportResult reportResult, Configuration configuration) {
        super(reportResult, "tagsHierarchy.vm", configuration);
    }

    @Override
    public String getWebPage() {
        return "tag-hierarchy.html";
    }
